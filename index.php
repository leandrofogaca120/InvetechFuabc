    ...
    if ($_SESSION['s_logado']) {
        ...
        <header>
            <div class="topo topo-color fixed-top " style="z-index:4;">
                ...
                <div id="header_logo">
                    <span class="logo"><img src="fuabc-icone.svg" width="45" class=""></span>
                </div>
                ...
                <div class="barra">
                    ...
                    if (empty($_SESSION['s_permissoes']) && $_SESSION['s_nivel'] != 1) {
                        ...
                        print "<a class='barra td-barra' id='HOME' onclick=\"loadPage('menu-sidebar.php?menu=hom #sidebar-loaded',loadMenu()); loadPageContent('hom');\" >&nbsp;Inicio&nbsp;</a>";

                        if ($_SESSION['s_nivel'] < 3) {

                            if (($_SESSION['s_ocomon'] == 1) && !isIn($_SESSION['s_area'], $screen['conf_ownarea_2'])) {
                                print "<a class='barra td-barra' id='OCOMON' onclick=\"loadPage('menu-sidebar.php?menu=oco #sidebar-loaded',loadMenu()); loadPageContent('oco'); \">&nbsp;Chamados&nbsp;</a>";
